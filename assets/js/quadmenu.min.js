        ...
        function (e, f, j, i) {
            ...
            function g() {
                ...
                i && !h && l(),
                    ...
                    i === c && m > e
                        ? l()
                        : !0 !== f && (h = setTimeout(i ? k : l, i === c ? e - m : e));
            }
            return (
                "boolean" != typeof f && ((i = j), (j = f), (f = c)),
                $.guid && (g.guid = j.guid = j.guid || $.guid++),
                g
            );
        }),
    ...
    (function ($) {
        ...
        var QuadMenuCollapse = function (element, options) {
            (this.$element = $(element)),
                ...
                (this.$trigger = $(
                    '[data-quadmenu="collapse"][href="#' +
                    element.id +
                    '"],[data-quadmenu="collapse"][data-target="#' +
                    element.id +
                    '"]'
                )),
        ...
        function Plugin(option) {
            return this.each(function () {
                var $this = $(this),
                    data = $this.data("quadmenu.collapse"),
                    options = $.extend(
                        {},
                ...
                !data &&
                    ...
                    $this.data(
                        "quadmenu.collapse",
                        (data = new QuadMenuCollapse(this, options))
                    ),
                    "string" == typeof option && data[option]();
            });
        }
        (QuadMenuCollapse.TRANSITION_DURATION = 350),
            (QuadMenuCollapse.DEFAULTS = { toggle: !0 }),
                        ...
                        if (
                            ...
                            var complete = function () {
                                ...
                                [dimension](""),
                                    ...
                                    this.$element.trigger("shown.quadmenu.collapse");
                            };
            ...
            (QuadMenuCollapse.prototype.getParent = function () {
                return $(this.options.parent)
                    .find(
                        '[data-quadmenu="collapse"][data-parent="' +
                        this.options.parent +
                        '"]'
                    )
                    .each(
                        $.proxy(function (i, element) {
                            var $element = $(element);
                            this.addAriaAndQuadMenuCollapsedClass(
            ...
            (QuadMenuCollapse.prototype.addAriaAndQuadMenuCollapsedClass = function (
                $element,
                $trigger
            ) {
        ...
        ($.fn.collapse = Plugin),
            ...
            $(document).on(
                "click.quadmenu.collapse.data-api",
                ...
                function (e) {
                    ...
                    var $target = getTargetFromTrigger($this),
                        data,
                        option = $target.data("quadmenu.collapse")
                            ? "toggle"
                            : $this.data();
        ...
        function Plugin(element, options) {
            ...
            (this.element = element),
                ...
                (this.perfectScrollbar =
                    void 0 !== $.fn.perfectScrollbar && !this.mobiledevice),
                this.touchenabled
        ...
        (Plugin.prototype = {
            init: function () {
                this.quadmenuResolveConflics(),
                    ...
                    this.quadmenuInitDropdownMaxHeight(),
            ...
            quadmenuResolveConflics: function () {
                this.$quadmenu.data("unwrap") &&
                    this.$quadmenu
                        .unwrap("nav")
                        .find(
                            ".quadmenu-item, .quadmenu-dropdown-toggle, .quadmenu-dropdown-menu, .quadmenu-dropdown-submenu"
                        )
                        .add(this.$quadmenu)
                        .removeAttr("style")
                        .unbind()
            ...
            quadmenuInitClasses: function (plugin) {
                (plugin = plugin || this).handleClasses(),
                    $(window).on(
                        "resize",
            ...
            handleClasses: function () {
                var template = this.$quadmenu.data("template"),
                    mobile = !!(
                        ...
                        window.innerWidth <= this.$quadmenu.data("breakpoint")
                    );
                mobile ||
                    "collapse" != template ||
                    ...
                    "offcanvas" != template ||
                    this.$quadmenu.addClass("quadmenu-is-horizontal"),
                    mobile && this.$quadmenu.removeClass("quadmenu-is-horizontal"),
                    this.$quadmenu.removeClass("no-js").addClass("js");
            },
            quadmenuInitDropdownTouchEvents: function (plugin) {
                (plugin = plugin || this),
                    this.settings.touchEvents &&
                    (this.$ul.on(
                        this.touchStart + ".quadmenu.toggle",
                        ".quadmenu-dropdown > .quadmenu-dropdown-toggle",
                        function (e) {
            ...
            quadmenuInitDropdownMouseEvents: function (plugin) {
                (plugin = plugin || this).handleDropdownMouseEvents(),
                    $(window).on(
                        "resize",
            ...
            handleDropdownMouseEvents: function (plugin) {
                (plugin = plugin || this),
                    this.$ul
                        .find(".quadmenu-item")
                        .off(
                            "mouseleave.hoverIntent mouseenter.hoverIntent mousemove.hoverIntent"
                        ),
                    ...
                    (this.$ul.on(
                        "click",
                        ".quadmenu-item > .quadmenu-dropdown-toggle",
                        function (e) {
                            plugin.handleLink(e, this);
                        }
                    ),
                        this.$ul.on(
                            "click.quadmenu.toggle",
                            ".quadmenu-item > .quadmenu-dropdown-toggle",
                            function (e) {
                                plugin.handleMouseClick(e, this, plugin);
                            }
                        ),
                        this.$quadmenu.hasClass("quadmenu-is-horizontal") &&
                        void 0 !== $.fn.hoverIntent &&
                        plugin.handleMouseHover(
                            this.$ul.find(
                                ".quadmenu-item > .quadmenu-dropdown-toggle.hoverintent"
                            ),
                            plugin
                        ));
            },
                    ...
                    $li.hoverIntent({
                        over: function () {
                            var $li = $(this),
                                $target;
                            $li
                                .find("> .quadmenu-dropdown-menu")
                                .data("quadmenu-killHover") ||
                        ...
                        out: function () {
                            ...
                            $li
                                .find("> .quadmenu-dropdown-menu")
                                .data("quadmenu-killHover") ||
                                $li.hasClass("quadmenu-item-type-tab") ||
            ...
            quadmenuInitDropdownRetractors: function (plugin) {
                (plugin = plugin || this),
                    this.$ul.on(
                        "click.retractor",
                        ".quadmenu-item.quadmenu-dropdown.open > .quadmenu-dropdown-toggle > .quadmenu-item-content > .quadmenu-caret",
                        function (e) {
                ...
                if (void 0 !== e.originalEvent)
                    if (e.originalEvent.touches)
                        (Math.abs(
                            ...
                            $target.data("quadmenu-startX")
                        ) > plugin.settings.moveThreshold ||
                            Math.abs(
                                e.originalEvent.touches[0].clientY -
                                $target.data("quadmenu-startY")
                            ) > plugin.settings.moveThreshold) &&
                            plugin.resetHandlers($target);
                    else if (e.originalEvent.clientY) {
                        var pos = $target.data(pos);
                        (Math.abs(
                            e.originalEvent.clientX - $target.data("quadmenu-startX")
                        ) > plugin.settings.moveThreshold ||
                            Math.abs(
                                e.originalEvent.clientY - $target.data("quadmenu-startY")
                            ) > plugin.settings.moveThreshold) &&
                            plugin.resetHandlers($target);
                    }
            },
            handleTouchTap: function (e, target, plugin) {
                ...
                var $target = $(target),
                    $li = $target.parent();
                $target.data("quadmenu-killClick", !0),
                    $target.data("quadmenu-killHover", !0),
                    setTimeout(function () {
                        $target
                            .data("quadmenu-killClick", !1)
                            .data("quadmenu-killHover", !1);
                    }, 1e3),
                    this.$quadmenu.hasClass("quadmenu-is-horizontal") &&
                    plugin.closeSubmenu($li.siblings(".open")),
                    $li.hasClass("quadmenu-dropdown")
                        ? $li.hasClass("open")
                            ? (($li.hasClass("quadmenu-item-type-tab") &&
                                this.$quadmenu.hasClass("quadmenu-is-horizontal")) ||
                                plugin.closeSubmenu($li),
                                plugin.handleLink(e, target, !0))
            ...
            handleMouseClick: function (e, target, plugin) {
                var $target = $(target),
                    $li = $target.parent(".quadmenu-item");
                !$target.data("quadmenu-killClick") &&
                    $li.length &&
                    ($li.hasClass("open")
                        ? $target.is("a") && plugin.handleLink(e, target)
                        : $li.hasClass("quadmenu-dropdown") &&
                        (e.preventDefault(),
                            this.$quadmenu.hasClass("quadmenu-is-horizontal") &&
                            plugin.closeSubmenu($li.siblings(".open")),
            ...
            handleDropdownCloseEnd: function (e, caret, plugin) {
                ...
                return plugin.closeSubmenu($li), $(caret).off(plugin.touchEnd), !1;
            },
            resetHandlers: function ($target) {
                $target.off(this.touchEnd), $target.off(this.touchMove);
            ...
            triggerSubmenu: function ($li, plugin) {
                plugin.closeSubmenu($li.siblings(".open")), plugin.openSubmenu($li);
            },
            ...
            handleClicks: function (e, target) {
                var $target;
                $(target).data("quadmenu-killClick") && e.preventDefault();
            },
            quadmenuInitDropdownCloseAll: function (plugin) {
                (plugin = plugin || this),
                    ...
                    $(document).on(
                        this.touchEnd +
                        ".hidden.quadmenu.dropdown.all click.hidden.quadmenu.dropdown.all",
                        function (e) {
                            $(e.target).closest("#quadmenu").length ||
            ...
            closeAllSubmenus: function () {
                ...
                $li.length && this.closeSubmenu($li, 100);
            },
            quadmenuInitDropdownMaxHeight: function (plugin) {
                (plugin = plugin || this),
                    ...
                    this.$quadmenu.hasClass("quadmenu-is-horizontal") &&
                    (this.$ul.on(
                        "shown.quadmenu.dropdown.height",
                        ".dropdown-maxheight",
                        function (e) {
                        ...
                        this.$ul.on(
                            "shown.quadmenu.dropdown.tabheight",
                            ".dropdown-maxheight.quadmenu-item-type-tab",
                            function (e) {
                        ...
                        $(window).on(
                            ...
                            $.debounce(300, function () {
                                plugin.$ul
                                    .find(".dropdown-maxheight > .quadmenu-dropdown-menu > ul")
                                    .css({ height: "", "overflow-y": "" })
                                    .removeData("quadmenu-dropdownHeight")
                                    .removeData("quadmenu-maxHeight");
                            })
                        ));
            },
            handleDropdownMaxHeight: function (li, minHeight) {
                if (void 0 !== $.fn.scrollTop) {
                    ...
                    if ($dropdown.length) {
                        ...
                        return (
                            $dropdown
                                .css({ height: Height + "px", "overflow-y": "auto" })
                                .data("quadmenu-maxHeight", Height),
                            Height
                        );
                    }
                }
            ...
            quadmenuInitNavbarSticky: function () {
                ...
                void 0 !== $.fn.scrollTop &&
                    this.$quadmenu.hasClass("quadmenu-is-horizontal") &&
                    ((plugin.$sticky = this.$quadmenu
                        .filter('[data-sticky="1"]')
                        .first()),
                        plugin.$sticky.length &&
                        ((plugin.is_sticky = !1),
                            $(window).on("load", function () {
                                ...
                                (plugin.sticky_height = plugin.$sticky.height()),
                                    ...
                                    (plugin.topYSticky = Math.max(
                                        plugin.$sticky.offset().top - plugin.adminbar_height,
                                        plugin.$sticky.data("sticky-offset"),
                                        plugin.sticky_height + plugin.adminbar_height
                                    )),
                                    plugin.topYSticky > plugin.sticky_offset &&
                                    plugin.$sticky.addClass("quadmenu-sticky-animation"),
                                    $(window).on("scroll", function () {
                                        var topY = $(this).scrollTop();
                                        plugin.is_sticky &&
                                            topY < plugin.topYSticky &&
            ...
            handleSticky: function () {
                ...
                this.is_sticky = !0;
                var placeholder = $("<div />")
                    .addClass("quadmenu-sticky-wrapper")
                    .css({ height: this.sticky_height + "px", position: "static" });
                this.$sticky
                    .find(".quadmenu-navbar-collapse.collapse.in")
                    .collapse("hide"),
                    this.$sticky.toggleClass("quadmenu-sticky-top").wrap(placeholder),
                    this.$sticky.trigger("sticking.quadmenu.navbar"),
                    this.$sticky.trigger("sticky.quadmenu.navbar");
            },
            handleUnSticking: function () {
                var plugin = this;
                (this.is_sticky = !1), this.$sticky.addClass("quadmenu-unsticking-top");
            },
            handleUnSticky: function () {
                var plugin = this;
                (this.is_sticky = !1),
                    this.$sticky.trigger("unsticking.quadmenu.navbar"),
                    setTimeout(function () { }, 200),
                    this.$sticky.removeClass("quadmenu-sticky-top"),
                    this.$sticky.unwrap(),
                    this.$sticky.trigger("unsticky.quadmenu.navbar");
            },
            quadmenuInitDropdownFloat: function (plugin) {
                (plugin = plugin || this).handleDropdownFloat(),
                    $(window).on(
                        "resize",
                        $.debounce(600, function () {
            ...
            handleDropdownFloat: function (plugin) {
                (plugin = plugin || this),
                    ...
                    this.$quadmenu.hasClass("quadmenu-is-horizontal") &&
                    this.$ul.on(
                        "shown.quadmenu.dropdown.float",
                        ".quadmenu-item.quadmenu-dropdown:not(.quadmenu-item-type-tab):not(.quadmenu-item-type-tabs)",
                        function (e) {
                            var $dropdown = $(this).find(
                                "> .quadmenu-dropdown-menu:not(.quadmenu-dropdown-stretch-content):not(.quadmenu-dropdown-stretch-dropdown)"
                            );
                            if ($dropdown.length) {
                                var elH = $dropdown.outerWidth(),
                                    W = $(window).innerWidth(),
                                    p,
                                    l = $dropdown.offset().left,
                                    r = parseInt(W - (l + elH));
                                $(this).hasClass("quadmenu-dropdown-left") && l < 0
                                    ? $dropdown.css({
                                        "margin-right":
                                            l - plugin.settings.containerGutter + "px",
                                    })
                                    : r < 0 &&
                                    $dropdown.css({
                                        "margin-left":
                                            r - plugin.settings.containerGutter + "px",
                                    });
                            }
                        }
                    );
            ...
            quadmenuInitWidth: function (plugin) {
                (plugin = plugin || this).$quadmenu.data("width") &&
            ...
            quadmenuInitContainerWidth: function (plugin) {
                (plugin = plugin || this).handleContainerWidth(plugin.$quadmenu),
                    this.$quadmenu.on(
                        "sticking.quadmenu.navbar unsticking.quadmenu.navbar",
                        function () {
            ...
            handleContainerWidth: function (navbar) {
                ...
                $navbar.data("selector") &&
                    $container.css({
                        width: $(this.$quadmenu.data("selector")).innerWidth() + "px",
                    });
            },
            quadmenuInitLazyLoad: function (plugin) {
                (plugin = plugin || this),
                    this.$quadmenu.on(
                        "init.quadmenu shown.quadmenu.collapse shown.quadmenu.dropdown",
                        function (e) {
                            $(this)
                                .find("img[data-src]:visible")
                                .each(function (e) {
                                    var $img = $(this),
                                        src = $img.data("src"),
            ...
            quadmenuInitNavbarOffcanvas: function (plugin) {
                (plugin = plugin || this),
                    this.$quadmenu.on(
                        "show.quadmenu.collapse shown.quadmenu.collapse hide.quadmenu.collapse hidden.quadmenu.collapse",
                        ".navbar-offcanvas",
                        function (e) {
                            var width = $(this).width(),
                                translateX = plugin.$quadmenu.hasClass(
                    ...
                    this.$quadmenu.on(
                        "show.quadmenu.offcanvas",
                        ".navbar-offcanvas",
                        function (e, translateX) {
                            var $transform;
                            $("> .quadmenu-navbar-toggle", plugin.$quadmenu)
                                .add($(".quadmenu-navbar-header", plugin.$quadmenu))
                    ...
                    this.$quadmenu.on(
                        "shown.quadmenu.offcanvas hidden.quadmenu.offcanvas",
                        ".navbar-offcanvas",
                        function (e, translateX) {
                            setTimeout(function () {
                                var $transform;
                                $(this)
                                    .add($("> .quadmenu-navbar-toggle", plugin.$quadmenu))
                                    .add($(".quadmenu-navbar-header", plugin.$quadmenu))
                                    .toggleClass("canvas-sliding");
                            }, 1e3);
                        }
                    ),
                    $(document).on(
                        this.touchStart +
                        ".hide.quadmenu.offcanvas click.hide.quadmenu.offcanvas",
                        function (e) {
                            var $target = $(e.target),
                                responsive = !!(
                                    plugin.settings.responsive &&
                                    window.innerWidth <= plugin.$quadmenu.data("breakpoint")
                                );
                            if (
                                !$target.closest("#quadmenu").length &&
                                responsive &&
                                ($target.on(plugin.touchEnd, function (e) {
            ...
            handleDropdownScrollbar: function (plugin) {
                (plugin = plugin || this),
                    ...
                    this.$quadmenu.hasClass("quadmenu-is-horizontal") &&
                    this.$ul.on(
                        "shown.quadmenu.dropdown.pscrollbar",
                        ".dropdown-maxheight",
                        function (e) {
                            (plugin.$dropdown = $(this).find(
                                "> .quadmenu-dropdown-menu > ul"
                            )),
                                plugin.$dropdown.on(
                                    "scroll",
                                    $.debounce(500, !0, function () {
                                        $(this).data("quadmenu-killHover", !0);
                                    })
                                ),
                                plugin.$dropdown.on(
                                    "scroll",
            ...
            handleVerticalScrollbar: function (plugin) {
                ((plugin = plugin || this).$offcanvas =
                    this.$quadmenu.find(".navbar-offcanvas")),
                    plugin.$offcanvas.perfectScrollbar("destroy").data("ps-id", !1),
                    this.$quadmenu.hasClass("quadmenu-is-horizontal") ||
                    (plugin.$offcanvas.on(
                        "shown.quadmenu.dropdown.pscrollbar hidden.quadmenu.dropdown.pscrollbar shown.quadmenu.offcanvas.pscrollbar hidden.quadmenu.offcanvas.pscrollbar",
                        function (e) {
                            var $psMenu = $(this);
                            $(this).on(
                                "mouseup mouseenter",
                                ...
                                function () {
                                    $psMenu
                                        .find(".quadmenu-item > .quadmenu-dropdown-toggle")
                                        .data("quadmenu-killHover", !0);
                                }
                            ),
                                $(this).on("mouseleave", ".ps-scrollbar-y-rail", function () {
                                    $psMenu
                                        .find(".quadmenu-item > .quadmenu-dropdown-toggle")
                                        .removeData("quadmenu-killHover");
                                }),
                                $psMenu.perfectScrollbar("update");
                        }
                    ),
                        plugin.$offcanvas.data("ps-id")
            ...
            quadmenuInitNavbarSlideBar: function (plugin) {
                (plugin = plugin || this),
                    this.$quadmenu.hasClass("quadmenu-is-horizontal") &&
                    this.$quadmenu.hasClass("quadmenu-hover-slidebar") &&
                    setTimeout(function () {
                        plugin.$ul.append(
                            '<li class="quadmenu-slidebar invisible"><span class="bar"></span></li>'
                        ),
            ...
            handleSlideBar: function (ul, plugin) {
                ...
                $ancestor.length && ($current = $ancestor),
                    $item.length && ($current = $item),
                    $open.length && ($current = $open),
                    slide_nav_css($current),
                    slide_nav.data("slidebar-style", slide_nav.attr("style")),
                    this.$ul.on(
                        "sticky.quadmenu.navbar.slidebar unsticky.quadmenu.navbar.slidebar",
                        function () {
                            ...
                            var $ul = $(this).find(".quadmenu-navbar-nav"),
                                ...
                                $active = $open.length
                                    ? $open
                                    : $ul.find("> li.quadmenu-item.quadmenu-item-level-0.active"),
                                $current;
                            slide_nav_css(
                                $active.length
                                    ? $active
                                    : $ul.find(li).not(".quadmenu-float-opposite").first()
                            ),
                                slide_nav.data("slidebar-style", slide_nav.attr("style"));
                        }
                    ),
                    $ul
                        .find("> li.quadmenu-item.quadmenu-has-link")
                        .on("hover.slidebar", function (e) {
                            slide_nav_css($(this));
                        }),
                    $ul
                        .find("> li.quadmenu-item.quadmenu-has-link")
                        .on("mouseleave.slidebar", function (e) {
                            slide_nav.attr("style", slide_nav.data("slidebar-style")).show();
                        }),
                    $ul.on(
                        "shown.quadmenu.dropdown.slidebar",
                        "> li.quadmenu-item.quadmenu-has-link",
                        function (e) {
                            $(this).find("> a").hasClass("click") &&
                                (slide_nav_css($(this)),
                                    slide_nav.data("slidebar-style", slide_nav.attr("style")));
                        }
                    ),
                    $ul.on(
                        "hide.quadmenu.dropdown.slidebar",
                        "> li.quadmenu-item.quadmenu-has-link",
                        function (e) {
                            $(this).find("> a").hasClass("click") &&
                                (slide_nav_css($current),
            ...
            handleTabs: function (plugin) {
                (plugin = plugin || this),
                    this.$ul.off(
                        "shown.quadmenu.dropdown.tabs",
                        ".quadmenu-item-type-tabs"
                    ),
                    this.$ul.off(
                        "shown.quadmenu.dropdown.tabheight",
                        ".quadmenu-item-type-tab"
                    ),
                    this.$ul
                        .find(".quadmenu-item-type-tab > .quadmenu-dropdown-menu > ul")
                        .data("quadmenu-maxHeight", !1)
                        .data("quadmenu-killHover", !1),
                    this.$ul
                        .find(".quadmenu-item-type-tab > .quadmenu-dropdown-menu > ul")
                        .removeAttr("style"),
                    ...
                    this.$ul.on(
                        ...
                        ".quadmenu-item-type-tabs",
                        function (e) {
                            $(e.target).hasClass("quadmenu-item-type-tabs") &&
                                plugin.openSubmenu(
                                    $(this).find(".quadmenu-item-type-tab:first")
                                );
                        }
                    );
            },
            handleTabsHeight: function (open) {
                var $open = $(open),
                    $tabs;
                $open
                    .closest(".quadmenu-dropdown-menu > ul")
                    .css({
                        "min-height":
                            $open
                                .find("> .quadmenu-dropdown-menu > ul")
                                .data("quadmenu-maxHeight") + "px",
                    });
            },
                ...
                if ($element.length)
                    return (
                        ...
                        ($element.data("element-style", $element.attr("style")),
                            ...
                            $element
                                .removeAttr("style")
                                .attr("style", $element.data("element-style"))),
                        $element.offset().top
                    );
            },
                ...
                (plugin = plugin || this),
                    ...
                    (this.$ul.on(
                        ...
                        this.$ul.on("mouseleave.hoverIntent", ".owl-carousel", function () {
                            var $owl = $(this);
                            "on" === $(this).data("autoplay") &&
                                $owl.trigger("play.owl.autoplay");
                        }),
                        this.$ul.on(
                            "hide.quadmenu.dropdown.carousel",
                            ".quadmenu-item",
                            function () {
                        ...
                        this.$ul.on(
                            "shown.quadmenu.dropdown.carousel",
                            ".quadmenu-item",
                            function (e) {
                                var $owl = $(this).find(".owl-carousel");
                                $owl.length && plugin.handleCarousel($owl, plugin);
                            }
                        ),
                        plugin.handleCarousel(
                            this.$ul.find(".quadmenu-item-level-0 > .owl-carousel"),
                            plugin
                        ));
            },
                ...
                (plugin = plugin || this),
                    $(owl).each(function () {
                        var $owl = $(this),
                            ...
                            autoplay = "on" === $owl.data("autoplay"),
                            pagination = "on" === $owl.data("pagination"),
                            dots = "on" === $owl.data("dots"),
            ...
            quadmenuInitItemLogIn: function (plugin) {
                (plugin = plugin || this),
                    this.$ul.on(
                        "hide.quadmenu.dropdown.login",
                        ".quadmenu-item-type-login",
                        function (e) {
                            var $li = $(this);
                            plugin.handleMouseHover(
                                $li.find("> .quadmenu-dropdown-toggle.hoverintent"),
                                plugin
                            );
                        }
                    ),
                    this.$ul.on(
                        "shown.quadmenu.dropdown.login",
                        ".quadmenu-item-type-login",
                        function (e) {
                            var $li = $(this);
            ...
            handleForm: function (e, li) {
                ...
                $(li)
                    ...
                    .on("submit", function (e) {
                        ...
                        var $form = $(this),
                            $dropdown = $form.closest(".quadmenu-dropdown-menu"),
            ...
            quadmenuInitItemSocial: function (plugin) {
                (plugin = plugin || this).handleSocial(),
                    $(window).on(
                        "resize",
                        $.debounce(600, function () {
                            plugin.handleSocial();
            ...
            handleSocial: function (plugin) {
                (plugin = plugin || this),
                    this.$ul.off(
                        "shown.quadmenu.dropdown.social hidden.quadmenu.dropdown.social"
                    ),
                    this.$quadmenu.hasClass("quadmenu-is-horizontal") &&
                    (this.$ul.on(
                        "shown.quadmenu.dropdown.social",
                        ".quadmenu-item-type-social",
                        function () {
                            plugin.$ul
                                .find(
                                    "> li.quadmenu-item.quadmenu-item-level-0:not(.quadmenu-item-type-social)"
                                )
                                .addClass("invisible"),
                                plugin.$ul
                                    .find("> li.quadmenu-slidebar")
                                    .addClass("invisible");
                        }
                    ),
                        this.$ul.on(
                            "hidden.quadmenu.dropdown.social",
                            ".quadmenu-item-type-social",
                            function () {
                                plugin.$ul
                                    .find(
            ...
            quadmenuInitItemCart: function (plugin) {
                var $cart = (plugin = plugin || this).$quadmenu.find(
            ...
            quadmenuInitItemWidgets: function (plugin) {
                $(document).on("show.quadmenu.dropdown", function (e) {
                    $(this)
                        .find(".widget_media_audio > video, .widget_media_audio > audio")
                        .each(function () {
                    ...
                    $(document).on("hidden.quadmenu.dropdown", function (e) {
                        $(this)
                            .find(".widget_media_video video, .widget_media_video audio")
                            .each(function () {
                                this.player.pause();
                            });
                    });
                    ...
                    : "string" == typeof options &&
                        ...
                        ? (this.each(function () {
                            ...
                            instance instanceof Plugin &&
                                ...
                                "destroy" === options && $.data(this, "plugin_quadmenu", null);
                        }),
